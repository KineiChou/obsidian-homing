...
export interface PersistedState { readonly schemaVersion: 1; readonly settings: OrganizerSettings; readonly filingQueue: readonly PersistedFilingEntry[]; readonly moveJournal: readonly MoveRecord[] }
